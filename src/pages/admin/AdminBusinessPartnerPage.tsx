...
const AdminBusinessPartnerPage: React.FC = () => {
  ...
  // 👇 [PERBAIKAN] State untuk Otorisasi Aksi Business Partner 👇
                  ...
                  applications.map((app) => (
                    <tr key={app.id} className="transition-colors hover:bg-gray-50/50">
                      ...
                      <td className="px-6 py-4 text-center whitespace-nowrap">
                        {app.status === 'pending' ? (
                          /* 👇 BUNGKUS TOMBOL APPROVE/REJECT DENGAN RBAC 👇 */
                          canAccess('business_partners.approve') ? (
                            ...
                            <span className="text-[10px] italic text-gray-400">Menunggu Persetujuan Admin</span>
                          )
                        ) : (
