...
//         // Cek dan format warna dari backend
//         if (Array.isArray(prodData.color)) {
//           const formattedColors = prodData.color.map((c: any) => {
//             if (typeof c === 'string') return { hex: c, name: "" }; // Format jadul
//             return c; // Format baru (object)
//           });
...
//             ? null
//             : formData.voucher_discount_price, // <--- BARU
...
//                 className="w-full p-2.5 bg-gray-200 border border-gray-200 rounded-lg outline-none text-gray-500 cursor-not-allowed"
//               />
//             </div>
//           </div> */}
...
//   // [PERBAIKAN] Menyimpan ID asli untuk pengiriman PUT request
...
//         // [PERBAIKAN] Fetch produk menggunakan SLUG
...
//         // Simpan ID asli untuk keperluan Update (PUT)
...
//       // [PERBAIKAN] Menggunakan ACTUAL ID untuk melakukan UPDATE (PUT)
...
//     name: "",
//     price: "",
//     wholesale_price: "", // <--- BARU: Harga Grosir
//     discount_price: "",
//     voucher_discount_price: "",
//     stock: "",
//     description: "",
...
//           name: prodData.name || "",
//           price: prodData.price ? prodData.price.toString() : "",
//           wholesale_price: prodData.wholesale_price ? prodData.wholesale_price.toString() : "", // <--- BARU
//           discount_price: prodData.discount_price ? prodData.discount_price.toString() : "",
//           voucher_discount_price: prodData.voucher_discount_price ? prodData.voucher_discount_price.toString() : "",
//           stock: prodData.stock ? prodData.stock.toString() : "0",
//           description: prodData.description || "",
...
//       const payload = {
//         ...formData,
//         wholesale_price: formData.wholesale_price === "" ? null : formData.wholesale_price, // <--- BARU
//         discount_price: formData.discount_price === "" ? null : formData.discount_price,
//         voucher_discount_price: formData.voucher_discount_price === "" ? null : formData.voucher_discount_price, 
//         color: colors.length > 0 ? colors : null,
//         image_url: uploadedImageUrl,
...
//             <div>
//               <label className="block mb-2 text-sm font-semibold text-gray-700">Harga Diskon Publik</label>
//               <div className="relative">
//                 <span className="absolute left-3 top-2.5 text-gray-500">Rp</span>
//                 <input type="number" placeholder="Kosongkan jika tidak ada" value={formData.discount_price} className="w-full pl-10 p-2.5 bg-gray-50 border border-gray-200 rounded-lg outline-none focus:border-gycora focus:ring-1 focus:ring-gycora transition-all" onChange={(e) => setFormData({ ...formData, discount_price: e.target.value })} />
//               </div>
