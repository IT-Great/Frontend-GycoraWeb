...
export default function AdminLayout({
  ...
  return (
    <div className="flex h-screen overflow-hidden font-sans bg-gray-50 relative">
      ...
      <div className="flex flex-col flex-1 overflow-hidden">
        {/* HEADER */}
        <header className="z-0 flex items-center justify-between h-16 px-4 sm:px-6 bg-white border-b border-gray-100 shadow-sm shrink-0">
          <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-4 md:gap-6">
            ...
            >
              ...
              <img
                ...
                alt="Profile Avatar"
                className="object-cover w-8 h-8 sm:w-10 sm:h-10 rounded-full shadow-sm ring-2 ring-gycora-light"
                onError={(e) => {
                  e.currentTarget.src = `https://ui-avatars.com/api/?name=${adminUser?.first_name}+${adminUser?.last_name}&background=059669&color=fff&bold=true`;
                }}
              />
        ...
        <main className="flex-1 overflow-y-auto bg-gray-50/50 p-4 md:p-6 custom-scrollbar">
          {children}
        </main>
      </div>
    </div>
