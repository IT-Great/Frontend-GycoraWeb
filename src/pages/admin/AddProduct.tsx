...
//   // 👇 States untuk menampung Multi-Currency Baru 👇
...
//           variantFiles.map((file) => uploadToS3(file, token)),
//         );
//       }
...
//       // Memfilter inputan kosong agar tidak dikirim ke JSON database
...
//         wholesale_prices:
//           Object.keys(filteredWholesale).length > 0 ? filteredWholesale : null, // 👇 Inject Data
//         voucher_discount_prices:
//           Object.keys(filteredVouchers).length > 0 ? filteredVouchers : null, // 👇 Inject Data
//         color: colors.length > 0 ? colors : null,
//         image_url: uploadedImageUrl,
//         variant_video: uploadedVideoUrl,
//         variant_images:
...
//               </div>
//             </div>
//             {/* 👇 SETTING BUNDLE KHUSUS 👇 */}
//             <div className="p-4 mt-6 border border-purple-100 rounded-xl bg-purple-50/50">
//               <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
//                 <div className="flex items-center gap-3">
//                   <input type="checkbox" id="is_bundle" checked={formData.is_bundle_active} onChange={(e) => setFormData({...formData, is_bundle_active: e.target.checked})} className="w-5 h-5 text-purple-600 border-gray-300 rounded focus:ring-purple-500" />
//                   <label htmlFor="is_bundle" className="text-sm font-bold text-purple-900 cursor-pointer">Aktifkan Syarat Bundle Kategori Berbeda</label>
//                 </div>
//                 {formData.is_bundle_active && (
//                   <div className="flex items-center gap-3 sm:ml-auto">
//                     <label className="text-xs font-bold text-purple-700">Berlaku Sampai:</label>
//                     <input type="datetime-local" value={formData.bundle_end_date} onChange={(e) => setFormData({...formData, bundle_end_date: e.target.value})} className="p-2 text-sm bg-white border border-purple-200 rounded-lg outline-none focus:border-purple-500" />
//                   </div>
//                 )}
//               </div>
//               <p className="mt-2 text-xs text-purple-600/80">*Jika aktif, harga bundle di atas akan berlaku apabila produk ini masuk keranjang bersama 1 produk dari kategori lain.</p>
//             </div>
//           </div>

//           {/* 👇 MULTI CURRENCY EXPANSION CARD LOOP 👇 */}
...
//           {/* SISA COMPONENT MEDIA, WARNA, DESKRIPSI TETAP SAMA PERSIS SEPERTI SEBELUMNYA */}
//           <div className="pt-6 space-y-6 border-t border-gray-100">
//             <h2 className="text-lg font-bold text-gray-900">Media Produk</h2>
//             <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
//               <div>
