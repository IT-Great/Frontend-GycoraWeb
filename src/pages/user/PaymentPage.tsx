...
//   const shippingCostObj = useMemo(
//     () => convertIDRtoActiveCurrency(shippingCostIDR),
//     [shippingCostIDR, convertIDRtoActiveCurrency],
//   );
...
//         Swal.fire(
//           "Gagal",
//           data.message || "Gagal memproses pesanan karena sistem sibuk.",
//           "error",
//         );
...
//     return (
//       <div className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-white">
//         <div className="w-8 h-8 border-4 rounded-full border-gycora border-t-transparent animate-spin"></div>
//       </div>
//     );
...
//             </div>
//             <p className="text-sm font-bold text-yellow-400 mb-4 animate-pulse">
//               {queueMessage}
//             </p>
//             <p className="text-sm text-gray-400 leading-relaxed">
//               Sistem kami sedang mengamankan stok barang Anda. <br />
//               <span className="text-white font-bold">
//                 Harap jangan tutup atau refresh halaman ini.
//               </span>
//             </p>
//           </div>
//         </div>
...
//               <p className="text-[9px] text-center text-gray-400 mt-2 italic">
//                 A/B Test Variant: <strong>{abVariant}</strong>.
//               </p>
//               {!selectedAddressId && (
//                 <p className="mt-4 text-[10px] tracking-tighter text-center text-red-500 uppercase">
//                   {t("pay_alert_no_address")}
...
//                 // 🌟 [PERBAIKAN MUTLAK] Reset state SEBELUM redirect agar tidak stuck saat user menekan tombol "Back" pada browser 🌟
//                 setIsWaitingRoomOpen(false);
//                 setIsProcessing(false);
                                ...
                                return (
                                    <div key={item.id} className="flex gap-4">
                                        ...
                                        <div className="flex-grow min-w-0">
                                            ...
                                            {/* 👇 [FITUR BARU] TAMPILAN SISA KUOTA HADIAH BUNDLE DI PAYMENT 👇 */}
                                            {isBundled && freshProd.has_bundle_freebie && (
                                                <div className="mt-1.5 mb-1">
                                                    {freshProd.bundle_freebie_quota > 0 ? (
                                                        <span className="inline-flex items-center gap-1.5 px-2 py-0.5 text-[9px] font-bold text-emerald-700 bg-emerald-50 border border-emerald-200 rounded animate-pulse">
                                                            <span>🎁 Free {freshProd.bundle_freebie_name}</span>
                                                            <span className="px-1 py-0.5 text-[8px] text-white bg-red-500 rounded">
                                                                Sisa: {freshProd.bundle_freebie_quota}
                                                            </span>
                                                        </span>
                                                    ) : (
                                                        <span className="inline-flex items-center gap-1 px-2 py-0.5 text-[9px] font-bold text-gray-400 bg-gray-50 border border-gray-200 rounded line-through">
                                                            🎁 Free {freshProd.bundle_freebie_name} (Habis)
                                                        </span>
                                                    )}
                                                </div>
                                            )}
