...
//   // 👇 [PERBAIKAN] Helper Cerdas untuk membaca harga dengan Number()
//   // eslint-disable-next-line @typescript-eslint/no-explicit-any
...
//   const checkoutTotalAmount = useMemo(() => {
//     return checkoutItems.reduce((sum, item) => {
//       // Panggil fungsi getActivePrice
//       let priceToUse = getActivePrice(item.product);
...
//       return sum + priceToUse * item.quantity;
//     }, 0);
//   }, [checkoutItems, appliedPromoType, userType]); // Tambahkan userType sbg dependency
...
//         const user = JSON.parse(userStr);
//         setAvailablePoints(user.point || 0);
//         // 👇 [BARU] Simpan tipe user ke state
...
//       if (res.ok && data.checkout_url) {
//         // [PERBAIKAN] GTM Event: add_payment_info update price
//         (window as any).dataLayer = (window as any).dataLayer || [];
//         (window as any).dataLayer.push({
//           event: "add_payment_info",
//           ecommerce: {
...
//             // eslint-disable-next-line @typescript-eslint/no-explicit-any
//             items: checkoutItems.map((item: any) => {
//               const itemPrice = getActivePrice(item.product);
//               return {
//                 item_id: item.product.id,
//                 item_name: item.product.name,
//                 price: itemPrice,
...
//                           {item.product.name}
//                         </p>
//                         {isWholesaleActive && !isVoucherActive && (
//                            <span className="px-1.5 py-0.5 text-[8px] font-bold text-white bg-blue-600 rounded">GROSIR</span>
//                         )}
//                       </div>
//                       <div className="flex items-center gap-2 mt-0.5">
//                         <p className="text-[10px] text-gray-400">
