...
//                         {/* 👇 [FITUR BARU] TAMPILAN HADIAH BUNDLE DI HISTORY 👇 */}
//                         {isHistoricallyBundled && detail.product?.has_bundle_freebie && (
//                             <div className="mt-1">
//                                 <span className="inline-flex items-center gap-1 px-1.5 py-0.5 text-[8px] font-bold text-emerald-700 bg-emerald-50 border border-emerald-200 rounded">
//                                     🎁 Free {detail.product.bundle_freebie_name}
//                                 </span>
//                             </div>
//                         )}
//                         {/* 👆 ============================================== 👆 */}
...
//                         {isHistoricallyBundled && detail.product?.has_bundle_freebie && (
//                             <div className="mt-1">
//                                 <span className="inline-flex items-center gap-1.5 px-2 py-0.5 text-[9px] font-bold text-emerald-700 bg-emerald-50 border border-emerald-200 rounded">
//                                     🎁 Free {detail.product.bundle_freebie_name}
//                                 </span>
//                             </div>
//                         )}
                ...
                <div className="flex gap-4 pb-2 overflow-x-auto md:gap-6 scroll-smooth" style={{ WebkitOverflowScrolling: "touch", scrollbarWidth: "none" }}>
                    {unifiedTabs.map((tab) => (
                        <button
                            key={tab.value}
                            onClick={() => setActiveUnifiedTab(tab.value)}
                            className={`pb-3 md:pb-4 font-bold text-[10px] md:text-xs uppercase tracking-widest transition-colors whitespace-nowrap border-b-2 flex items-center gap-1.5 md:gap-2 shrink-0 ${activeUnifiedTab === tab.value ? "border-black text-black" : "border-transparent text-gray-400 hover:text-gray-700"
                                }`}
                        >
                            {tab.label}
                            {getUnifiedTabCount(tab.value) > 0 && (
                            ...
                            <div className="flex gap-1">
                                {visiblePages.map((page, index) => (
                                    <button
                                        ...
                                        onClick={() => typeof page === "number" ? setCurrentPage(page) : null}
                                        disabled={page === "..."}
                                        className={`w-7 h-7 md:w-10 md:h-10 rounded-lg md:rounded-xl font-medium transition flex items-center justify-center text-[10px] md:text-sm ${currentPage === page ? "bg-black text-white border-black" : "hover:bg-gray-50 border-gray-200"
                                            } ${page === "..." ? "cursor-default border-transparent hover:bg-transparent" : "border"}`}
                                    >
                                        {page}
                                    </button>
