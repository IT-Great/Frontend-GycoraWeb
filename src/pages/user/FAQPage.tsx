...
export default function FAQPage() {
  ...
  // Data FAQ dipindahkan ke dalam komponen agar fungsi t() terbaca
  const faqCategories = [
    {
      title: t("faq_cat1_title"),
      faqs: [
        { question: t("faq_c1_q1"), answer: t("faq_c1_a1") },
        { question: t("faq_c1_q2"), answer: t("faq_c1_a2") },
        { question: t("faq_c1_q3"), answer: t("faq_c1_a3") },
        { question: t("faq_c1_q4"), answer: t("faq_c1_a4") },
        { question: t("faq_c1_q5"), answer: t("faq_c1_a5") },
        { question: t("faq_c1_q6"), answer: t("faq_c1_a6") },
        { question: t("faq_c1_q7"), answer: t("faq_c1_a7") }
      ]
    },
    {
      title: t("faq_cat2_title"),
      faqs: [
        { question: t("faq_c2_q1"), answer: t("faq_c2_a1") },
        { question: t("faq_c2_q2"), answer: t("faq_c2_a2") },
        { question: t("faq_c2_q3"), answer: t("faq_c2_a3") },
        { question: t("faq_c2_q4"), answer: t("faq_c2_a4") },
        { question: t("faq_c2_q5"), answer: t("faq_c2_a5") }
      ]
    },
    {
      title: t("faq_cat3_title"),
      faqs: [
        { question: t("faq_c3_q1"), answer: t("faq_c3_a1") },
        { question: t("faq_c3_q2"), answer: t("faq_c3_a2") },
        { question: t("faq_c3_q3"), answer: t("faq_c3_a3") },
        { question: t("faq_c3_q4"), answer: t("faq_c3_a4") },
        { question: t("faq_c3_q5"), answer: t("faq_c3_a5") }
      ]
    },
    {
      title: t("faq_cat4_title"),
      faqs: [
        { question: t("faq_c4_q1"), answer: t("faq_c4_a1") },
        { question: t("faq_c4_q2"), answer: t("faq_c4_a2") },
        { question: t("faq_c4_q3"), answer: t("faq_c4_a3") }
      ]
    }
  ];
  ...
  return (
    <div className="min-h-screen py-20 font-sans bg-white">
      <div className="max-w-3xl px-4 mx-auto sm:px-6 lg:px-8">
        ...
        {/* Header Section */}
        <div className="mb-16 animate-fade-in-up">
          <h2 className="mb-4 text-sm font-bold tracking-widest text-center uppercase text-gycora">
            {t("faq_page_subtitle")}
          </h2>
          <h1 className="mb-6 text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl md:text-5xl">
            {t("faq_page_title")}
        ...
        <div className="p-10 mt-20 text-center bg-gray-900 rounded-3xl animate-fade-in-up" style={{ animationDelay: "200ms" }}>
          ...
          <Link 
            to={`/${lang}/pages/contact-us`} // [PERBAIKAN] Tambah prefix lang pada link kontak
            className="inline-block px-8 py-3 font-bold transition-all rounded-full bg-gycora text-white hover:bg-gycora-dark hover:-translate-y-0.5 shadow-lg shadow-emerald-500/20"
          >
            {t("faq_support_btn")}
          </Link>
