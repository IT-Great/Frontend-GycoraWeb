...
//   const itemsPerPage = 12; // Menampilkan 12 produk per halaman (cocok untuk grid 3x4 atau 4x3)
...
//         cancelButtonText: t("cancel")
//       }).then((result) => {
//         // [PERBAIKAN] Gunakan urlPrefix agar routing bahasa tidak rusak
...
//       {/* Header Banner */}
//       <div className="relative py-20 overflow-hidden text-center bg-gray-900 border-b border-gray-800 animate-fade-in">
//         <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1598440947619-2ce6598c4e1d?q=80&w=1500')] bg-cover bg-center opacity-20"></div>
//         <div className="absolute inset-0 bg-gradient-to-t from-gray-900 via-gray-900/80 to-transparent"></div>
//         <div className="relative z-10 px-4">
//           <h1 className="text-4xl font-extrabold tracking-tight text-white md:text-5xl drop-shadow-md">{t("banner_title")}</h1>
//           <p className="max-w-2xl mx-auto mt-4 text-gray-300">
//             {t("banner_desc")}
//           </p>
//         </div>
...
//               {isSearching && (
//                 <div className="absolute right-4 top-3.5 w-4 h-4 border-2 border-gray-300 border-t-[#006A4E] rounded-full animate-spin"></div>
//               )}
//             </div>
//           </div>
//         </div>
...
//              {lang === 'en' ? 'Showing' : 'Menampilkan'} <span className="font-bold text-gray-900">{totalItems}</span> {lang === 'en' ? 'products' : 'produk'}
//           </div>
//         )}
...
//           </div>
//         ) : totalItems === 0 ? (
//           <div className="py-20 text-center bg-white border border-gray-100 border-dashed rounded-3xl animate-fade-in-up">
//             <h3 className="text-xl font-bold text-gray-700">{searchQuery ? (lang === 'en' ? "Product Not Found" : "Produk Tidak Ditemukan") : t("no_product_found")}</h3>
//             <p className="mt-2 text-gray-500">{searchQuery ? (lang === 'en' ? "Sorry, our search engine couldn't find any products matching your query." : "Maaf, mesin pencari kami tidak dapat menemukan produk yang sesuai dengan ketikan Anda.") : t("no_product_desc")}</p>
//             <button onClick={handleClearSearch} className="mt-6 text-sm font-bold text-[#006A4E] hover:underline px-6 py-2 bg-emerald-50 rounded-full transition-colors hover:bg-emerald-100">
//               {lang === 'en' ? 'Show All Products' : 'Tampilkan Semua Produk'}
//             </button>
//           </div>
//         ) : (
//           <>
...
//                   <Link 
//                     key={product.id} 
//                     to={`${urlPrefix}/product/${product.slug}`} // [PERBAIKAN] Menggunakan urlPrefix
//                     state={{ 
//                       initialProduct: product,
//                       allProducts: products
//                     }}
...
//             {totalPages > 1 && (
//               <div className="flex flex-col items-center justify-between w-full gap-4 pt-8 mt-12 border-t border-gray-100 md:flex-row animate-fade-in-up">
//                 <p className="text-xs text-gray-500">
//                   {lang === 'en' ? 'Showing' : 'Menampilkan'} <span className="font-bold text-gray-900">{(currentPage - 1) * itemsPerPage + 1}</span> - <span className="font-bold text-gray-900">{Math.min(currentPage * itemsPerPage, totalItems)}</span> {lang === 'en' ? 'of' : 'dari'} <span className="font-bold text-gray-900">{totalItems}</span> {lang === 'en' ? 'products' : 'produk'}
//                 </p>
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 animate-fade-in">
              {paginatedProducts.map((product) => {
                ...
                return (
                  <Link 
                    key={product.id} 
                    to={`${urlPrefix}/product/${product.slug}`} 
                    state={{ 
                      initialProduct: product,
                      allProducts: products
                    }}
