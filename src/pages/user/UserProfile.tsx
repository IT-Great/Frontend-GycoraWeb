...
//   // ============================================================================
//   // LOGIKA KELENGKAPAN PROFIL (PROGRESS BAR)
//   // ============================================================================
...
//     if (user.profile_image) score += 15;
//     if (addresses.length > 0) score += 15;
//     return score;
//   }, [user, addresses]);
...
//           icon: "success",
//           title: "Berhasil!",
//           text: editingId ? t("toast_address_updated") : t("toast_address_added"),
//           timer: 1500,
//           showConfirmButton: false,
//         });
//         setIsModalOpen(false);
...
//           <div className="relative px-6 pb-8 mt-14 sm:mt-16 lg:px-10">
//             <div className="flex flex-col gap-8 lg:flex-row lg:items-start lg:justify-between">
              
//               {/* Bagian Kiri: Info Utama & Avatar */}
...
//                   <div className="flex flex-col items-center gap-2 mt-3 text-gray-500 sm:flex-row sm:gap-4">
//                     <span className="flex items-center gap-1.5 text-sm font-medium">
...
//                       </svg>
//                       {user.phone ? user.phone : <span className="italic text-gray-400">Belum diatur</span>}
//                     </span>
//                   </div>

//                   {/* Progress Bar Kelengkapan Profil */}
//                   <div className="w-full max-w-sm mt-5">
//                     <div className="flex justify-between mb-1.5 text-xs font-bold text-gray-600">
...
//                       <p className="mt-2 text-[10px] text-gray-400 italic">Lengkapi profil Anda untuk pengalaman yang lebih baik.</p>
//                     )}
//                   </div>
//                 </div>
//               </div>

//               {/* Bagian Kanan: Stats Cards (Poin, Member Sejak, Tipe) */}
//               <div className="flex flex-col gap-3 lg:w-72 shrink-0">
//                 <div className="flex items-center gap-4 p-4 transition-transform bg-gray-900 shadow-lg rounded-2xl hover:-translate-y-1">
//                   <div className="flex items-center justify-center w-12 h-12 rounded-full shadow-inner bg-[#006A4E]/20 text-[#006A4E] shrink-0">
//                     <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
//                       <path fillRule="evenodd" d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.006 5.404.434c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354 7.373 21.18c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.434 2.082-5.005z" clipRule="evenodd" />
//                     </svg>
//                   </div>
...
//                     <p className="text-2xl font-black text-white leading-none mt-0.5">
//                       {new Intl.NumberFormat("id-ID").format(user.point || 0)}{" "}
//                       <span className="ml-1 text-xs font-medium text-emerald-400">{t("profile_pts_label")}</span>
//                     </p>
//                   </div>
//                 </div>
...
//                       {user.usertype === 'reseller' ? 'Mitra Grosir' : 'Pelanggan'}
//                     </p>
//                   </div>
//                   <div className="p-3 border border-gray-100 bg-gray-50 rounded-xl">
//                     <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Bergabung</p>
//                     <p className="text-sm font-bold text-gray-800">{getJoinDate(user.created_at)}</p>
//                   </div>
//                 </div>
//               </div>
//             </div>
...
//             {/* Action Buttons */}
//             <div className="flex flex-wrap justify-center gap-3 pt-6 mt-8 border-t border-gray-100 lg:justify-start">
//               <button
//                 onClick={() => navigate(`${urlPrefix}/business-partner-page`)}
//                 className="flex items-center gap-2 px-5 py-2.5 text-sm font-bold text-gray-900 transition-colors bg-[#D4FF32] border border-[#D4FF32] shadow-sm rounded-xl hover:bg-[#bce520]"
//               >
...
//               </button>
//               <button
//                 onClick={() => navigate(`${urlPrefix}/favorites`)}
//                 className="flex items-center gap-2 px-5 py-2.5 text-sm font-bold text-gray-700 transition-colors bg-white border border-gray-200 shadow-sm rounded-xl hover:bg-gray-50 hover:text-[#006A4E]"
//               >
//                 <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
//                       className="w-full px-4 py-3 pl-10 text-sm font-medium text-gray-900 bg-white border-0 shadow-lg outline-none rounded-xl focus:ring-2 focus:ring-[#006A4E]"
//                     />
//                     <svg className="absolute w-5 h-5 text-gray-400 left-3 top-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export default function UserProfile() {
  ...
  const getProgressBarColor = (score: number) => {
    if (score === 100) return "bg-emerald-500 shadow-emerald-400/50";
    if (score >= 70) return "bg-amber-400 shadow-amber-400/50";
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans pb-20">
      ...
      <div className="relative w-full h-64 sm:h-72 bg-gradient-to-br from-[#004B36] via-[#006A4E] to-emerald-600 overflow-hidden">
        {/* Decorative elements */}
        <div className="absolute top-0 right-0 w-64 h-64 rounded-full bg-white opacity-5 translate-x-1/3 -translate-y-1/3"></div>
        <div className="absolute bottom-0 left-0 w-48 h-48 rounded-full bg-emerald-400 opacity-10 -translate-x-1/3 translate-y-1/3 blur-2xl"></div>
      </div>

      <div className="max-w-7xl px-4 mx-auto sm:px-6 lg:px-8 -mt-32 relative z-10 space-y-8">

        {/* --- KARTU PROFIL UTAMA --- */}
        <div className="bg-white rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-100 p-6 sm:p-10 flex flex-col lg:flex-row lg:items-center gap-8 lg:gap-12">

          {/* Avatar & User Info */}
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 flex-1">
            <div className="relative group shrink-0">
              <div className="p-1.5 bg-white rounded-full shadow-lg ring-1 ring-gray-100">
                {user.profile_image ? (
                  <img
                    src={user.profile_image}
                    alt="Profile"
                  ...
                  <div className="flex items-center justify-center w-32 h-32 sm:w-40 sm:h-40 text-5xl font-extrabold text-[#006A4E] uppercase rounded-full bg-emerald-50">
                    {user.first_name.charAt(0)}{user.last_name.charAt(0)}
                  </div>
                )}
              </div>
              ...
              <button
                onClick={() => fileInputRef.current?.click()}
                disabled={isUploadingImage}
                className="absolute inset-1.5 flex items-center justify-center transition-all duration-300 rounded-full opacity-0 cursor-pointer bg-black/50 backdrop-blur-sm group-hover:opacity-100 disabled:cursor-not-allowed"
                title="Ubah Foto Profil"
              >
                {isUploadingImage ? (
            ...
            <div className="text-center sm:text-left flex-1 mt-2">
              ...
              <div className="flex flex-col items-center sm:items-start gap-2 text-gray-500">
              ...
              {/* Progress Bar Kelengkapan Profil */}
              <div className="w-full max-w-sm mt-6 p-4 rounded-2xl bg-gray-50 border border-gray-100">
                <div className="flex justify-between mb-2 text-xs font-bold text-gray-700 uppercase tracking-widest">
                  <span>Kelengkapan Profil</span>
                  <span className={profileCompletion === 100 ? "text-emerald-600" : ""}>{profileCompletion}%</span>
                </div>
                <div className="w-full h-2.5 overflow-hidden bg-gray-200 rounded-full shadow-inner">
                  <div
                    className={`h-full transition-all duration-1000 ease-out rounded-full shadow-sm ${getProgressBarColor(profileCompletion)}`}
                    style={{ width: `${profileCompletion}%` }}
                  ></div>
                </div>
                {profileCompletion < 100 && (
                  <p className="mt-2 text-[10px] text-gray-500 italic">Lengkapi profil Anda untuk pengalaman belanja terbaik.</p>
                )}
              </div>
            </div>
          </div>

          {/* Statistik Kanan (Poin & Info) */}
          <div className="flex flex-col gap-4 w-full lg:w-80 shrink-0">
            {/* Poin Card Premium */}
            <div className="relative overflow-hidden p-6 rounded-3xl bg-gray-900 text-white shadow-2xl shadow-gray-900/30 group cursor-default transition-transform hover:-translate-y-1">
              <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-emerald-400 to-[#D4FF32] opacity-20 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2"></div>

              <div className="relative z-10 flex items-center gap-4">
                <div className="flex items-center justify-center w-14 h-14 rounded-2xl bg-emerald-500/20 text-[#D4FF32] border border-emerald-500/30">
                ...
                <div>
                  ...
                  <p className="text-3xl font-extrabold text-white leading-none">
                    {new Intl.NumberFormat("id-ID").format(user.point || 0)}
                    <span className="ml-1.5 text-xs font-bold text-[#D4FF32] uppercase">{t("profile_pts_label")}</span>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="p-4 border border-gray-100 bg-white rounded-2xl shadow-sm">
                <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1.5">Tipe Akun</p>
                <p className="text-sm font-bold text-[#006A4E] capitalize flex items-center gap-1.5">
                  <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span>
                  {user.usertype === 'reseller' ? 'Mitra Grosir' : 'Pelanggan'}
                </p>
              </div>
              <div className="p-4 border border-gray-100 bg-white rounded-2xl shadow-sm">
                <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1.5">Bergabung</p>
                <p className="text-sm font-bold text-gray-800">{getJoinDate(user.created_at)}</p>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-wrap justify-center sm:justify-start gap-4">
          <button
            onClick={() => navigate(`${urlPrefix}/business-partner-page`)}
            className="flex items-center gap-2.5 px-6 py-3 text-sm font-bold text-gray-900 transition-all bg-[#D4FF32] shadow-sm rounded-2xl hover:bg-[#c1eb25] hover:-translate-y-0.5 hover:shadow-md"
          >
          ...
          <button
            onClick={handleOpenProfileModal}
            className="flex items-center gap-2.5 px-6 py-3 text-sm font-bold text-white transition-all shadow-md bg-[#006A4E] rounded-2xl hover:bg-emerald-900 hover:shadow-lg hover:-translate-y-0.5"
          >
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
            </svg>
          ...
          <button
            onClick={() => navigate(`${urlPrefix}/favorites`)}
            className="flex items-center gap-2.5 px-6 py-3 text-sm font-bold text-gray-700 transition-all bg-white border border-gray-200 shadow-sm rounded-2xl hover:bg-gray-50 hover:text-[#006A4E] hover:-translate-y-0.5"
          >
        ...
        {/* --- BUKU ALAMAT --- */}
        <div className="p-6 sm:p-10 bg-white shadow-xl shadow-gray-200/40 rounded-3xl border border-gray-100">
          <div className="flex flex-col gap-4 pb-6 mb-8 border-b border-gray-100 sm:flex-row sm:items-end sm:justify-between">
            <div>
              <h2 className="text-2xl font-extrabold tracking-tight text-gray-900">
                {t("address_book_title")}
              </h2>
            ...
            <button
              onClick={() => handleOpenModal()}
              className="flex items-center justify-center gap-2 px-6 py-3 text-sm font-bold text-white transition-all bg-gray-900 shadow-md rounded-2xl hover:bg-gray-800 hover:shadow-lg hover:-translate-y-0.5 shrink-0"
            >
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4v16m8-8H4" />
              </svg>
          ...
          {addresses.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-20 border-2 border-gray-200 border-dashed bg-gray-50 rounded-3xl">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              {addresses.map((addr) => (
                <div
                  key={addr.id}
                  className={`relative flex flex-col p-6 rounded-3xl border transition-all duration-300 ${addr.is_default
                      ? "border-l-4 border-l-[#006A4E] border-y-gray-100 border-r-gray-100 shadow-md bg-white ring-1 ring-emerald-500/10"
                ...
                >
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex items-center gap-3">
                      <div
                        className={`flex items-center justify-center w-12 h-12 rounded-2xl ${addr.is_default ? "bg-emerald-50 text-[#006A4E]" : "bg-gray-50 text-gray-400"}`}
                      >
                        {addr.details.type === "home" ? (
                    ...
                    {addr.is_default && (
                      <span className="px-3 py-1.5 text-[10px] font-black tracking-widest text-[#006A4E] uppercase bg-emerald-100 rounded-lg">
                        {t("label_main_address")}
                      </span>
                    )}
                  </div>
                  ...
                  <div className="flex items-center justify-between pt-5 mt-5 border-t border-gray-100">
                    <p className="text-xs font-semibold text-gray-400 truncate max-w-[50%]">
                      {t("district")} ({addr.details.region})
                    </p>
                    <div className="flex items-center gap-4">
                      <button
                        onClick={() => handleOpenModal(addr)}
                        className="text-sm font-bold transition-colors text-[#006A4E] hover:text-emerald-800"
                      >
                        {t("btn_edit")}
                      </button>
                      <div className="w-1 h-1 bg-gray-300 rounded-full"></div>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fade-in-up">
          <div className="flex flex-col w-full max-w-md overflow-hidden bg-white shadow-2xl rounded-3xl">
            <div className="flex items-center justify-between p-6 border-b border-gray-100 bg-gray-50/50">
              <h3 className="text-xl font-extrabold tracking-tight text-gray-900">{t("change_profile")}</h3>
              <button onClick={() => setIsProfileModalOpen(false)} className="p-2 text-gray-400 transition-colors rounded-full hover:text-gray-900 hover:bg-gray-100">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12" /></svg>
              </button>
            </div>
            <form onSubmit={handleSubmitProfile} className="p-6 space-y-5">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block mb-1.5 text-[11px] font-bold text-gray-500 uppercase tracking-widest">{t("label_first_name")}</label>
                  <input
                    type="text" required value={profileFormData.first_name}
                    onChange={(e) => setProfileFormData({ ...profileFormData, first_name: e.target.value })}
                    className="w-full p-3 text-sm font-medium transition-all bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-[#006A4E] focus:border-transparent outline-none"
                  />
                </div>
                <div>
                  <label className="block mb-1.5 text-[11px] font-bold text-gray-500 uppercase tracking-widest">{t("label_last_name")}</label>
                  <input
                    type="text" required value={profileFormData.last_name}
                    onChange={(e) => setProfileFormData({ ...profileFormData, last_name: e.target.value })}
                    className="w-full p-3 text-sm font-medium transition-all bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-[#006A4E] focus:border-transparent outline-none"
              ...
              <div>
                <label className="block mb-1.5 text-[11px] font-bold text-gray-500 uppercase tracking-widest">Email</label>
                <input
                  type="email" required value={profileFormData.email}
                  onChange={(e) => setProfileFormData({ ...profileFormData, email: e.target.value })}
                  className="w-full p-3 text-sm font-medium transition-all bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-[#006A4E] focus:border-transparent outline-none"
              ...
              <div>
                <label className="block mb-1.5 text-[10px] font-bold text-gray-500 uppercase tracking-widest">{t("label_phone")}</label>
                <input
                  type="phone" placeholder="Ex: 081234567890" value={profileFormData.phone}
                  onChange={(e) => setProfileFormData({ ...profileFormData, phone: e.target.value })}
                  className="w-full p-3 text-sm font-medium transition-all bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-[#006A4E] focus:border-transparent outline-none"
                />
              </div>
              <div className="flex justify-end gap-3 pt-6 mt-2 border-t border-gray-100">
                <button type="button" onClick={() => setIsProfileModalOpen(false)} className="px-6 py-2.5 text-sm font-bold text-gray-600 transition-colors bg-gray-100 rounded-xl hover:bg-gray-200">
                  {t("cancel")}
                </button>
                <button type="submit" className="px-6 py-2.5 text-sm font-bold text-white transition-all shadow-md bg-[#006A4E] rounded-xl hover:bg-emerald-900 hover:shadow-lg">
                  {t("btn_update_address")}
                </button>
              </div>
            </form>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fade-in-up">
          <div className="flex flex-col w-full max-w-sm overflow-hidden bg-white shadow-2xl rounded-3xl">
            ...
            <form onSubmit={handleSubmitPassword} className="p-6 space-y-5">
              ...
              <div className="flex justify-end gap-3 pt-6 mt-2 border-t border-gray-100">
                <button type="button" onClick={() => setIsPasswordModalOpen(false)} className="px-6 py-2.5 text-sm font-bold text-gray-600 transition-colors bg-gray-100 rounded-xl hover:bg-gray-200">
                  {t("btn_cancel")}
                </button>
                <button type="submit" className="px-6 py-2.5 text-sm font-bold text-white transition-all shadow-md bg-gray-900 rounded-xl hover:bg-black hover:shadow-lg">
                  {t("btn_save_pwd")}
                </button>
              </div>
            </form>
      ...
      {/* --- MODAL FORM ALAMAT DENGAN PETA --- */}
      {isModalOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 pt-10 pb-10 overflow-y-auto bg-black/60 backdrop-blur-sm animate-fade-in-up">
          <div className="flex flex-col w-full max-w-5xl my-auto overflow-hidden bg-white shadow-2xl rounded-3xl">
            <div className="flex items-center justify-between p-6 border-b border-gray-100 bg-gray-50 shrink-0">
              <h3 className="text-xl font-extrabold tracking-tight text-gray-900">
                {editingId ? t("modal_edit_address_title") : t("modal_add_address_title")}
            ...
            <div className="flex flex-col md:flex-row h-auto md:h-[650px] overflow-hidden">
              ...
              <div className="relative w-full bg-gray-100 border-b border-gray-200 h-72 md:h-full md:w-5/12 md:border-b-0 md:border-r shrink-0">
                <div className="absolute top-4 left-4 right-4 z-[1000]">
                  <div className="relative">
                    <input
                      ...
                      value={searchQuery}
                      onChange={handleSearchChange}
                      className="w-full px-4 py-3.5 pl-11 text-sm font-medium text-gray-900 bg-white/90 backdrop-blur-md border border-gray-200 shadow-lg outline-none rounded-2xl focus:bg-white focus:ring-2 focus:ring-[#006A4E] focus:border-transparent transition-all"
                    />
                    <svg className="absolute w-5 h-5 text-gray-400 left-4 top-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                    </svg>
                    {isSearching && (
                      <span className="absolute right-4 top-4 w-4 h-4 border-2 rounded-full border-[#006A4E] border-t-transparent animate-spin"></span>
                    )}
                  </div>

                  {suggestions.length > 0 && (
                    <div className="absolute w-full mt-2 overflow-hidden bg-white shadow-xl rounded-2xl border border-gray-100">
                      {suggestions.map((place) => (
                        <div
                          key={place.place_id}
                          onClick={() => handleSelectSuggestion(place)}
                          className="px-4 py-3 text-sm transition-colors border-b border-gray-50 cursor-pointer hover:bg-gray-50 last:border-b-0"
                        >
                          <p className="font-bold text-gray-800 line-clamp-1">{place.display_name.split(",")[0]}</p>
                          <p className="text-[10px] text-gray-500 line-clamp-1 mt-0.5">{place.display_name}</p>
                        </div>
                      ))}
                    </div>
                  )}
                ...
                <button
                  type="button" onClick={handleGetCurrentLocation} disabled={isGettingLocation}
                  className="absolute z-[1000] bottom-6 left-1/2 -translate-x-1/2 flex items-center gap-2 bg-white text-gray-900 px-5 py-2.5 rounded-full shadow-xl font-bold text-xs hover:bg-gray-50 border border-gray-200 transition-all hover:-translate-y-0.5"
                >
                  {isGettingLocation ? (
                    <span className="w-4 h-4 border-2 rounded-full border-[#006A4E] border-t-transparent animate-spin"></span>
              ...
              <form onSubmit={handleSubmitAddress} className="flex flex-col flex-1 p-6 space-y-6 overflow-y-auto bg-white sm:p-8 custom-scrollbar">
                <div className="flex gap-3 p-4 border border-blue-100 rounded-2xl bg-blue-50/50">
                  ...
                  <p className="text-xs font-medium leading-relaxed text-blue-800">{t("guide_map_text")}</p>
                </div>
                ...
                <div className="space-y-5">
                  ...
                  <div>
                    <label className="block mb-1.5 text-[10px] font-bold text-gray-500 uppercase tracking-widest">{t("label_full_address")}</label>
                    <textarea
                      required rows={3} placeholder={t("placeholder_full_address")} value={formData.address_location}
                      onChange={(e) => setFormData({ ...formData, address_location: e.target.value })}
                      className="w-full p-3 text-sm font-medium transition-all bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-[#006A4E] focus:border-transparent outline-none resize-none"
                    ></textarea>
                  </div>
