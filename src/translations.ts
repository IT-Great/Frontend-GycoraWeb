...
export const translations = {
  id: {
    ...
    product_faq_empty: "Belum ada pertanyaan yang sering diajukan untuk produk ini.",
    product_review_empty: "Belum ada ulasan untuk produk ini.",
    product_verified_buyer: "Verified Buyer",
    
    // Taglines
    brush_tagline: "Rambut Lebih Rapi, Halus, dan Mudah Diatur dalam Sekali Sisir ✨",
    scalp_tagline: "Scalp Massager untuk Kulit Kepala Lebih Bersih, Nyaman, dan Sehat ✨",
    
    // Content Tabs General
    guide_title: "Cara Penggunaan yang Tepat",
    
    // Brush Tab Contents
    brush_desc_p1: "Kenalin Ethereal Glow Brush, hairbrush anti-static dengan teknologi konduktif dan molekul karbon yang dirancang untuk membantu rambut terasa lebih halus, rapi, dan tampak berkilau setiap hari.",
    brush_desc_p2: "Dengan desain fleksibel yang mengikuti kontur kepala serta bulu sisir yang lembut di kulit kepala, pengalaman menyisir jadi terasa lebih nyaman tanpa rasa sakit atau tarikan berlebih.",
    brush_desc_p3: "Cocok untuk kamu yang ingin rambut tetap terlihat rapi di tengah aktivitas harian — tanpa perlu effort styling yang ribet.",
    brush_benefits_title: "Kenapa Banyak yang Suka Ethereal Glow Brush?",
    brush_benefit_1_bold: "Anti-Static Technology: ",
    brush_benefit_1_text: "Membantu mengurangi rambut mengembang, kusut, dan sulit diatur.",
    brush_benefit_2_bold: "Membantu Rambut Tampak Lebih Halus & Berkilau: ",
    brush_benefit_2_text: "Setiap sapuan sisir membantu merapikan rambut sekaligus meningkatkan kilau alami.",
    brush_benefit_3_bold: "Flexible & Soft Bristles: ",
    brush_benefit_3_text: "Lembut di kulit kepala untuk membantu mengurangi rasa sakit dan rambut patah.",
    brush_benefit_4_bold: "Spiral Comb Design: ",
    brush_benefit_4_text: "Desain spiral mengikuti bentuk kepala dengan lebih nyaman.",
    brush_benefit_5_bold: "Eco-Friendly Material: ",
    brush_benefit_5_text: "Terbuat dari material Polylactic Acid Fiber yang ramah lingkungan.",
    ...
    // Brush Guide
    brush_guide_1: "Pastikan rambut dalam keadaan kering atau setengah kering (jangan basah kuyup).",
    brush_guide_2: "Sisir perlahan dari bagian tengah atau ujung rambut terlebih dahulu untuk mengurai kusut.",
    brush_guide_3: "Setelah bagian bawah rapi, lanjutkan menyisir dari akar hingga ke ujung rambut.",
    brush_guide_4: "Gunakan setiap pagi atau kapan pun rambut terasa berantakan/statis.",
    
    // Brush FAQ
    brush_faq_q1: "Q: Apakah aman untuk rambut rontok?",
    brush_faq_a1: "A: Ya, bulu sisirnya didesain lembut dan fleksibel sehingga meminimalisir tarikan yang bisa menyebabkan rambut patah/rontok.",
    brush_faq_q2: "Q: Bagaimana cara membersihkan sisir ini?",
    brush_faq_a2: "A: Kamu bisa menggunakan sikat kecil untuk membuang helaian rambut, lalu lap permukaan sisir dengan kain basah/tisu basah. Hindari merendam di dalam air terlalu lama.",

    // Scalp Tab Contents
    scalp_desc_p1: "Kenalin Eco Serenity Scalp Care, scalp massager inovatif dari Gycora yang dirancang untuk membantu membersihkan kulit kepala sekaligus memberikan sensasi pijatan yang menenangkan setiap hari.",
    scalp_desc_p2: "Dengan desain fleksibel dan 196 teeth dengan ukuran berbeda, Eco Serenity mampu menjangkau area kulit kepala secara lebih menyeluruh untuk membantu mengangkat kotoran, minyak berlebih, dan penumpukan pada kulit kepala tanpa rasa kasar atau iritasi.",
    scalp_desc_p3: "Bukan cuma nyaman digunakan saat keramas, tapi juga cocok untuk relaksasi di tengah aktivitas yang padat.",
    scalp_benefits_title: "Kenapa Banyak yang Suka Eco Serenity Scalp Care?",
    scalp_benefit_1_bold: "Triple-Fold Structure Design: ",
    scalp_benefit_1_text: "Desain fleksibel yang mengikuti bentuk kepala untuk pijatan nyaman maksimal.",
    scalp_benefit_2_bold: "196 Flexible Teeth: ",
    scalp_benefit_2_text: "Membantu membersihkan merata dan memberi sensasi relaxing.",
    ...
    scalp_benefit_4_text: "Pijatan lembut bantu melancarkan sirkulasi kulit kepala.",
    ...
    scalp_benefit_7_text: "Cocok saat rambut kering (relaksasi) maupun saat keramas (pembersihan ekstra).",
    ...
    // Scalp Guide
    scalp_guide_1: "Saat Keramas: Aplikasikan sampo secara merata, gunakan Scalp Care dengan gerakan melingkar yang lembut untuk membersihkan kulit kepala.",
    scalp_guide_2: "Saat Rambut Kering: Gunakan sebagai alat pijat relaksasi di sela-sela aktivitas harian dengan tekanan ringan.",
    scalp_guide_3: "Bilas Scalp Care dengan air bersih setelah penggunaan bersama produk perawatan rambut.",
    
    // Scalp FAQ
    scalp_faq_q1: "Q: Apakah alat ini membuat rambut makin kusut saat keramas?",
    scalp_faq_a1: "A: Tidak, gunakan dengan gerakan memijat ke satu arah atau melingkar kecil. Hindari menggosok maju-mundur secara kasar agar rambut tetap rapi.",
    scalp_faq_q2: "Q: Apakah aman untuk kulit kepala sensitif?",
    scalp_faq_a2: "A: Sangat aman. Silikon yang digunakan cukup fleksibel sehingga memberikan pijatan tanpa melukai kulit kepala.",

    // Static Review Translations
    review_brush_1: "Sisir nya bagus banget sih sesuai dgn claim nya sblmnya aku pakai brand w krn rambutku rontok.. trs setelah aku compare sm brand Gycora ternyata jauh lbh ga rontok pakai Gycora",
    review_brush_2: "Sisirnya enak banget terutama buat rambut yg suka kusut Jd lebih gampang pake sisir dari Gycora..",
    review_brush_3: "Setelah saya pakai hair brush nya rambutku jadi lebih gak kusut dan bikin lebih pede pastinya..",
    review_brush_4: "Oke kok enak sisir nya lentur ngikutin kepala. ga nyangkut2 hehe",
    review_brush_5: "Sukaaa poll sma sisirnya... Rambut jd makin teratur pas disisir dan ga gerundel (kusut frizzy) n rambut ku ya uda ga tllu banyak yg rontok. terus sisirnya tu empuk dan nyaman poll di kepala ga sakit.",
    review_scalp_1: "Kemasan: Bagus\nEfek: Ketombe keluar semua, semoga bisa bersih pakai ini\nPengalaman Penggunaan: Rasanya rambut halus setelah pakai.",
  },
  en: {
    // Nav Menu
    home: "Home",
    ...
    // Taglines
    brush_tagline: "Smoother, Neater, and Manageable Hair in Just One Stroke ✨",
    scalp_tagline: "Scalp Massager for Cleaner, More Comfortable, and Healthier Scalp ✨",
    
    // Content Tabs General
    guide_title: "Proper Usage Guide",
    
    // Brush Tab Contents
    brush_desc_p1: "Meet the Ethereal Glow Brush, an anti-static hairbrush engineered with conductive technology and carbon molecules designed to help hair feel smoother, neater, and look naturally shiny every day.",
    brush_desc_p2: "Featuring a flexible design that matches the contours of your head alongside ultra-soft bristles, it provides a seamless brushing experience without causing scalp pain or hair pulling.",
    brush_desc_p3: "Perfect for those who want effortlessly neat and managed hair amidst a busy day—without the need for tedious styling routines.",
    brush_benefits_title: "Why People Love the Ethereal Glow Brush?",
    brush_benefit_1_bold: "Anti-Static Technology: ",
    brush_benefit_1_text: "Helps reduce frizz, tangles, and unmanageable flyaways effectively.",
    brush_benefit_2_bold: "Enhances Smoothness & Natural Shine: ",
    brush_benefit_2_text: "Every single stroke dynamically aligns hair cuticles to bring out a natural, healthy glow.",
    brush_benefit_3_bold: "Flexible & Soft Bristles: ",
    brush_benefit_3_text: "Extremely gentle on the scalp, minimizing hair breakage and split ends.",
    brush_benefit_4_bold: "Spiral Comb Design: ",
    brush_benefit_4_text: "The ergonomic spiral frame contours to your head shape for maximum comfort.",
    brush_benefit_5_bold: "Eco-Friendly Material: ",
    brush_benefit_5_text: "Crafted out of environmentally sustainable Polylactic Acid Fiber.",
    ...
    // Brush Guide
    brush_guide_1: "Ensure hair is completely dry or towel-damp (avoid using on soaking wet hair).",
    brush_guide_2: "Gently detangle from the mid-lengths to the ends first to remove stubborn knots safely.",
    brush_guide_3: "Once the lower section is free-flowing, smoothly brush from the roots all the way down.",
    brush_guide_4: "Incorporate into your routine every morning or whenever static and frizz build up.",
    
    // Brush FAQ
    brush_faq_q1: "Q: Is it safe to use on thinning or brittle hair?",
    brush_faq_a1: "A: Absolutely. The bristles are specifically tuned to be soft and ultra-flexible, reducing high-tension pulling that triggers unnecessary hair loss.",
    brush_faq_q2: "Q: What is the best way to clean this hairbrush?",
    brush_faq_a2: "A: You can use a smaller styling cleaning brush to clear stray hair strands, then wipe down with a damp cloth or microfiber towel. Avoid long submersions in water.",

    // Scalp Tab Contents
    scalp_desc_p1: "Discover the Eco Serenity Scalp Care massager, an innovative dynamic tool from Gycora expertly built to deeply cleanse your scalp while providing a relaxing massage therapy at home.",
    scalp_desc_p2: "Featuring an advanced flexible tri-fold framework and 196 multi-sized flexible teeth, it thoroughly clears dirt, buildup, and excess sebum without causing microscopic skin irritation.",
    scalp_desc_p3: "An absolute game-changer during showers for shampoo lathering, or on dry hair for a midday stress relief session.",
    scalp_benefits_title: "Why People Love the Eco Serenity Scalp Care?",
    scalp_benefit_1_bold: "Triple-Fold Structure Design: ",
    scalp_benefit_1_text: "Contours instantly to your head anatomy for optimal uniform pressure distribution.",
    scalp_benefit_2_bold: "196 Flexible Teeth: ",
    scalp_benefit_2_text: "Provides deep-reaching exfoliation and sensory relaxation safely.",
    scalp_benefit_3_bold: "Deep Scaling & Exfoliation: ",
    scalp_benefit_3_text: "Lifts oily scales, persistent residue, and styling product buildup.",
    scalp_benefit_4_bold: "Relaxing Scalp Massage: ",
    scalp_benefit_4_text: "Increases local microcirculation to supply optimal nourishment to hair roots.",
    scalp_benefit_5_bold: "Anti-Microbial Silver Ion: ",
    scalp_benefit_5_text: "Impregnated silver ions inhibit bacterial growth on the tool surfaces.",
    scalp_benefit_6_bold: "Ergonomic & Comfortable Grip: ",
    scalp_benefit_6_text: "Locks perfectly in your palm even when wet and slippery.",
    scalp_benefit_7_bold: "Multi-functional Framework: ",
    scalp_benefit_7_text: "Works flawlessly on dry hair for relaxation or wet hair for active scalp scaling.",
    scalp_benefit_8_bold: "Eco-Friendly Material: ",
    ...
    // Scalp Guide
    scalp_guide_1: "During Wash: Apply shampoo uniformly, then press the Scalp Care tool down and glide in small gentle circular motions to deep clean.",
    scalp_guide_2: "Dry Exfoliation: Use as a stress-relief massage tool across the scalp applying gentle baseline pressure.",
    scalp_guide_3: "Rinse the Scalp Care tool thoroughly under clean water after exposure to treatments and conditioners.",
    
    // Scalp FAQ
    scalp_faq_q1: "Q: Will it cause severe hair tangling during active shampooing?",
    scalp_faq_a1: "A: No. Move the massager unidirectionally or in targeted tight circles. Avoid vigorous back-and-forth scrubbing to prevent structural tangling.",
    scalp_faq_q2: "Q: Is this massager completely safe on inflamed or sensitive scalps?",
    scalp_faq_a2: "A: The medical-grade flexible tips are soft enough to deliver therapy without scratching or breaching compromised skin.",

    // Static Review Translations
    review_brush_1: "This brush is incredibly good and does exactly what it claims. I previously used a major competitor's brush due to severe hair fall, but switching to Gycora drastically reduced my breakage.",
    review_brush_2: "Brushing feels completely effortless now, especially on hair that tends to get knotty easily. Gycora makes daily detangling so much simpler.",
    review_brush_3: "Since using this premium brush, my hair extensions and natural ends don't lock up anymore. It definitely gives a major confidence boost.",
    review_brush_4: "Excellent structural flexibility! It molds beautifully to the head contour and glides through smoothly without snapping hair.",
    review_brush_5: "I am absolutely in love with this brush! Hair looks instantly polished and structured without looking frizzy. The cushion is soft and acts like a true head massage.",
    review_scalp_1: "Packaging: Beautiful\nEffect: Cleared up stubborn flakes immediately. Hoping for a long-term clear scalp, hair feels exceptionally soft post-wash.",
  }
};
